...
for (var x=0; x<questions.length; x++) {
  ...
  buttons[x].addEventListener('click', function() {
    ...
    if (inputs[questionId].value.toLowerCase() == questions[questionId].english.toLowerCase()) {
      this.parentElement.style.backgroundColor = "#33f79f";
...
submitbtn.addEventListener('click', function() {
  if (
    (cards[0].style.backgroundColor == "#33f79f") &&
    (cards[1].style.backgroundColor == "#33f79f") &&
    (cards[2].style.backgroundColor == "#33f79f") &&
    (cards[3].style.backgroundColor == "#33f79f") &&
    (cards[4].style.backgroundColor == "#33f79f") &&
    (cards[5].style.backgroundColor == "#33f79f") &&
    (cards[6].style.backgroundColor == "#33f79f") &&
    (cards[7].style.backgroundColor == "#33f79f") &&
    (cards[8].style.backgroundColor == "#33f79f") 
  ) {
