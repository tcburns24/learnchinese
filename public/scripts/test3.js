...
submitbtn.addEventListener('click', function() {
  if (
    (cards[0].style.backgroundColor == "lightgreen") &&
    (cards[1].style.backgroundColor == "lightgreen") &&
    (cards[2].style.backgroundColor == "lightgreen") &&
    (cards[3].style.backgroundColor == "lightgreen") &&
    (cards[4].style.backgroundColor == "lightgreen") &&
    (cards[5].style.backgroundColor == "lightgreen") &&
    (cards[6].style.backgroundColor == "lightgreen") &&
    (cards[7].style.backgroundColor == "lightgreen") &&
    (cards[8].style.backgroundColor == "lightgreen") 
  ) {
